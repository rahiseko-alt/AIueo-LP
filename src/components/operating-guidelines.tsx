const guidelines = [
  ...
  {
    title: 'イベント登録と参加',
    body: 'イベントを登録・主催する場合は、AIueoの会員登録が必要です。イベントへの参加だけなら、会員登録は必要ありません。会員登録なしで勝手にイベントを打つことはできません。',
  },
  {
    title: '個人情報・認証',
    body: 'AIueoは、住所・電話番号・参加者名簿を取得しません。企画を掲載する会員のログインはGoogleアカウントで行い、Googleから渡されるメールアドレス・表示名と、ご自身に入力いただく公開名だけを扱います。パスワードは預かりません。詳細はプライバシーポリシーをご覧ください。',
  },
  {
    title: '禁止事項と措置',
    body: 'AIueoは、この場を乱す行為を認めません。無断でイベントを立てる、参加者を困らせる、虚偽の告知をする、他人を傷つける、マルチ商法などの勧誘に使う、アダルト系イベントを登録するといった行為は禁止です。違反する掲載、またはAIueoがこの場に不適切と判断した掲載は、予告なく非公開・削除します。違反した会員は、予告なく登録を取り消します。',
  },
  {
    title: '費用',
  ...
  {
    title: 'イベントの取り消し',
    body: 'イベントの取り消しは主催者に一任します。参加者が1名でも集まっている場合、主催者は自己責任で会員へ説明してください。',
  },
  {
    title: '著作権・禁止事項',
    ...
    <section id="guidelines" className="section-padding border-b border-[rgba(240,237,232,0.08)] bg-[#0b0b0b]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10">
        ...
        <p className="mt-10 border-t border-[rgba(240,237,232,0.08)] pt-5 font-mono text-[10px] leading-relaxed tracking-wide text-[rgba(240,237,232,0.6)] sm:text-xs">
          AIueoは、必要に応じて掲載内容・会員登録・企画の公開を見直し、非公開・削除・登録取消の措置を行うことがあります。利用前に、主催者が提示する個別の条件も必ず確認してください。
        </p>
