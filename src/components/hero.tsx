...
export function Hero({ activity }: HeroProps) {
  return (
    <section id="home" className="relative h-[100svh] min-h-[30rem] overflow-hidden bg-[#080808] lg:min-h-[36rem]">
      ...
      <div
        aria-label="AIueo"
        className="pointer-events-none absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center gap-[0.18em] font-mono text-[clamp(2.75rem,13vw,9rem)] font-semibold leading-none tracking-[-0.09em] text-[#f0ede8]/90 drop-shadow-[0_4px_28px_rgba(0,0,0,0.65)]"
      >
