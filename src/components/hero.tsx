      ...
      <div className="hero-split border-b border-[rgba(240,237,232,0.08)] bg-[#080808]">
        ...
        <div className="hero-media relative w-full overflow-hidden bg-[#141414]">
          <Image
            ...
            priority
          />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#080808]/35 via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:via-transparent lg:to-[#080808]/20" />
        </div>
      </div>
    </section>
  );
