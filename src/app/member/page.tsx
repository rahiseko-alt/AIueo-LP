    ...
    <main className="min-h-screen bg-[#080808] px-4 py-8 text-[#f0ede8] sm:px-6 sm:py-12 md:px-10">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-8 border border-[rgba(200,164,90,0.42)] bg-[#12110d] p-6 sm:p-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3"><Link href="/member/proposals/new" className="btn-solid">企画を登録する</Link><Link href="/member/profile" className="btn-ghost">プロフィール・規約同意</Link></div>
        </section>
      </div>
    </main>
  );
